...
const BOX_TYPES = {
  ...
  octaves:        { zone: "any", description: "Stack N octaves of an array of MIDI pitches above the originals. octaves 1 doubles, octaves 2 triples, etc. Inlet 1 sets N dynamically (hot).", args: "[n]", example: "octaves 2",
                    inlets: [{ name: "in", type: "array", description: "Input array of MIDI pitches" },
                             { name: "n", type: "number", hot: true, description: "Number of octaves above (live)" }],
