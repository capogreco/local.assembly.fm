...
const BOX_TYPES = {
  ...
  "scope~":       { zone: "any", description: "3D Lissajous oscilloscope. Maps 3 audio signals to X/Y/Z. Knot colour via audio-rate HSB.",
                    inlets: [
                      ...
                      { name: "bgH", type: "number", description: "Background hue (0-1)" },
                      { name: "bgS", type: "number", description: "Background saturation (0-1)" },
                      { name: "bgB", type: "number", description: "Background brightness (0-1)" }],
                    outlets: [] },
